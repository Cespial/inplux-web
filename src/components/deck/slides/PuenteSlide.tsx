 ...
 * Lámina 7 · El puente.
 *
 * Sin ella, lo que sigue son cinco aplicaciones sueltas. Con ella, los cinco
 ...
 * `repeat(auto-fit, minmax(…, 1fr))`, que reparte las miniaturas que haya —hoy
 * cinco, mañana las que sean— y colapsa las pistas vacías. Añadir un perfil a
 ...
 * llevan con su peso completo; repetirla cinco veces aquí, en cuerpo de pie, la
 * convierte en ruido y quita sitio a lo único que esta lámina afirma, que es la
