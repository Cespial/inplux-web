...
export const homeCopyEs: HomeCopy = {
  ...
  allyNotice: {
    eyebrow: "ALIADOS DEL DÍA D",
    title: "Somos aliados del Día D.",
    lead: "La invasión del conocimiento llega a Medellín: un día para cruzar capital, tecnología, energía y salud en el mismo cuarto.",
    whenLabel: "CUÁNDO",
    when: "Miércoles 14 de octubre de 2026",
    whereLabel: "DÓNDE",
    where: "Auditorio Fundadores · Universidad EAFIT · Medellín",
    roleLabel: "NUESTRO PAPEL",
    role: "Software · De un problema real a producción",
    alliesEyebrow: "CON QUIÉNES",
    allyNotes: {
      veronorte: "Capital · Puente con el venture capital global",
      eafit: "Sede · Donde se piensa por primeros principios",
      makeno: "Logística",
      mbs: "Trust y sociedades en el exterior · Menos fricción",
      macrowise: "Epistemic Capital · Macro y geopolítica para LATAM",
      celsia: "Energía · El piso físico de todo lo demás",
    },
    cta: "Ver el Día D",
    dismiss: "Seguir en INPLUX",
    closeLabel: "Cerrar el aviso",
    dialogLabel: "INPLUX es aliado del Día D, 14 de octubre de 2026 en Medellín",
  },
  experienceRail: {
    ...
    clientNotes: {
      ...
      "/brand/clients/alcaldia-santo-domingo.png": "Gestión pública territorial",
      "/brand/clients/alcaldia-el-bagre.png": "Gestión pública territorial",
      "/brand/clients/alcaldia-valparaiso.png": "Gestión pública territorial",
      "/brand/clients/alcaldia-vegachi.png": "Gestión pública territorial",
