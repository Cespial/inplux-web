    ...
    <LazyMotion features={domMax} strict>
      ...
      <nav className={`fixed left-0 right-0 z-50 nav-wrap transition-[top] duration-300 ${bannerOpen ? "top-10" : "top-0"} ${scrolled ? "scrolled" : ""}`} aria-label="Navegación principal">
        <div className="max-w-[1100px] mx-auto px-5 md:px-8 flex items-center justify-between h-[60px]">
          <a href="#inicio" className="text-ink font-semibold text-[1.1rem] tracking-[0.08em] uppercase" aria-label="INPLUX - Inicio">INPLUX</a>
        ...
        <div className="max-w-[1100px] mx-auto px-5 md:px-8">
          ...
          <Reveal className="w-full overflow-x-auto">
            <svg viewBox="0 0 1000 700" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-[1000px] mx-auto min-w-[700px]" style={{ fontFamily: "var(--font-body), system-ui, sans-serif" }} role="img" aria-label="Ecosistema INPLUX: dos frentes (público y privado) con seis productos sobre un motor agéntico compartido">
              ...
              <text x="662" y="393" textAnchor="middle" fill="#0d7d74" fontSize="7" fontWeight="600" opacity="0.7">↕ también Público</text>
        ...
        <div className="max-w-[1100px] mx-auto px-5 md:px-8">
          <Stagger className="grid grid-cols-2 md:grid-cols-4 gap-x-8 gap-y-12 md:gap-x-12 md:gap-y-14">
            {[
              ...
              { value: "2", label: "Frentes de mercado", detail: "Público · Privado" },
            ].map((stat) => (
      ...
      <section id="publico" className="py-24 md:py-32">
        <div className="max-w-[1100px] mx-auto px-5 md:px-8">
      ...
      <section id="privado" className="py-24 md:py-32 bg-warm">
        <div className="max-w-[1100px] mx-auto px-5 md:px-8">
          <Reveal className="mb-14">
            ...
            <p className="text-gray-500 text-base md:text-lg max-w-xl leading-relaxed">
              Para empresas, firmas legales y startups. Kelsen — el cerebro legal de INPLUX — integra Tribai (inteligencia tributaria) y Laudos (arbitral y jurisprudencia) sobre una sola capa de conocimiento persistente con citación verificable.
            </p>
          </Reveal>
          ...
          {/* Para quién · qué te llevas · CTA — Legal */}
          <Reveal className="grid md:grid-cols-3 gap-6 md:gap-8 mt-14 items-start">
            ...
            <div className="md:pt-5">
              ...
              <a href="https://kelsen.io" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-gray-500 hover:text-ink text-sm font-semibold mt-3 ml-1.5 transition-colors">
                Conoce Kelsen.io
      ...
      <footer className="py-14 md:py-16 border-t border-border">
        <div className="max-w-[1100px] mx-auto px-5 md:px-8">
          <div className="grid md:grid-cols-5 gap-8 mb-10">
            <div>
              <span className="text-ink font-semibold text-[0.8125rem] tracking-[0.08em] uppercase block mb-3">INPLUX</span>
